# **MyArknight**
# **基于图像识别与 ADB 控制的明日方舟手游自动化脚本v3.06**
...
v3.01 修改招募组合确认问题；修改招募干员招募失败问题；修改地图主界面识别错误问题

v3.02 修改部分节点事件判定错误问题；添加<险路小径>节点判定

v3.03 修改不期而遇事件处理问题，添加不期而遇事件

v3.04 修改存款时携带源石锭不足的问题

v3.05 修改招募券滑动失败问题

v3.06 优化装备穿戴逻辑，避免无意义卡顿；修改坐标设置错误问题
